...
export const actions = {
	default: async ({ request, params }) => {
		...
		console.log(`Selected items for ${appName}/${transactionName}:`, selectedItems);
		...
		const response = await fetch(`http://${env.SAM_GRAF_SERVER}/Applications/${appName}/Transactions/${transactionName}/LinkTypes/Selected`, {
			method: 'POST',
			headers: {
